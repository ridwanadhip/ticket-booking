...
INSERT INTO `event` (`id`, `name`, `image_url`, `description`, `start_at`, `finish_at`, `booking_start_at`, `booking_finish_at`, `total_ticket`, `max_ticket_per_user`, `ticket_price`, `venue_id`) VALUES (1, 'march celebration', 'https://assets.loket.com/2024/06/tips-buat-event.jpeg', 'celebrating the wonderful march', '2026-03-02 00:00:00', '2026-03-02 03:00:00', '2026-03-01 00:00:00', '2026-03-01 10:00:00', 10, 6, 50000, 1);
...
INSERT INTO `event` (`id`, `name`, `image_url`, `description`, `start_at`, `finish_at`, `booking_start_at`, `booking_finish_at`, `total_ticket`, `max_ticket_per_user`, `ticket_price`, `venue_id`) VALUES (3, 'wonderful saturday concert', 'https://voca-land.sgp1.cdn.digitaloceanspaces.com/-1/1769868458106/1719a5ec.jpg', 'wonderful saturday of 2026', '2026-04-03 00:00:00', '2026-04-03 03:00:00', '2026-04-02 00:00:00', '2026-04-02 03:00:00', 30, 1, 100000, 2);
INSERT INTO `event` (`id`, `name`, `image_url`, `description`, `start_at`, `finish_at`, `booking_start_at`, `booking_finish_at`, `total_ticket`, `max_ticket_per_user`, `ticket_price`, `venue_id`) VALUES (4, 'february super party', 'https://voca-land.sgp1.cdn.digitaloceanspaces.com/-1/1769868458106/1719a5ec.jpg', 'super party on the wonderful february. let\''s celebrate!', '2026-02-25 00:00:00', '2026-02-25 04:00:00', '2026-02-19 00:00:00', '2026-02-22 00:00:00', 20, 1, 120000, 1);
...
INSERT INTO `user` (`id`, `name`, `email`) VALUES (3, 'pratama', 'pratama@gmail.com');
INSERT INTO `booking` (`id`, `user_id`, `event_id`, `ticket_serial`, `booked_at`, `status`) VALUES (21, 3, 1, 'BOOK-1771593764-1', '2026-02-20 20:22:44', 'BOOKED');
INSERT INTO `booking` (`id`, `user_id`, `event_id`, `ticket_serial`, `booked_at`, `status`) VALUES (22, 3, 1, 'BOOK-1771593764-2', '2026-02-20 20:22:44', 'BOOKED');
INSERT INTO `booking` (`id`, `user_id`, `event_id`, `ticket_serial`, `booked_at`, `status`) VALUES (23, 3, 1, 'BOOK-1771593764-3', '2026-02-20 20:22:44', 'BOOKED');
INSERT INTO `booking` (`id`, `user_id`, `event_id`, `ticket_serial`, `booked_at`, `status`) VALUES (24, 3, 1, 'BOOK-1771593764-4', '2026-02-20 20:22:44', 'BOOKED');
INSERT INTO `booking` (`id`, `user_id`, `event_id`, `ticket_serial`, `booked_at`, `status`) VALUES (25, 3, 1, 'BOOK-1771593769-1', '2026-02-20 20:22:50', 'BOOKED');
INSERT INTO `booking` (`id`, `user_id`, `event_id`, `ticket_serial`, `booked_at`, `status`) VALUES (26, 3, 1, 'BOOK-1771593769-2', '2026-02-20 20:22:50', 'BOOKED');
